<template >
    <div class="flex justify-center flex-col items-center text-center py-[100px]  font-['Rubik'] w-[586px] h-screen h-[100%]">
      ...
      <div class="w-[301px]">
          ...
          <p class="font-normal text-[12px] leading-[16px] text-[#B2B7C1]">Tez orada siz bilan operatorimiz bog’lanib, barcha ma’lumotlarni aniqlashtiradi.</p>
      </div>
    </div>
</template>
<script>
