<template>
    <nav class=" flex items-center ml-[auto] font-['SF Pro Text'] font-bold text-[14px] leading-[21px] text-[#28293D]">
       <router-link class='mr-[39px] ' to='/'>Asosiy</router-link>
       <router-link class='mr-[39px]' to='/grants'>Grantlar</router-link>
       <router-link class='mr-[39px]' to='/tax-exemption'>Soliq imtiyozlari</router-link>
